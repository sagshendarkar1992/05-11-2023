...
namespace Vzah.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { IsActive = true, UsrPassword = model.Password, UserType = "End User", UserName = model.UserName, Email = model.Email, OTP = model.OTP, Mobile = model.Mobile };
        ...
        private ActionResult RedirectToLocal(string returnUrl, string UserName, string Password)
        {
            ...
            else if (obj.USER_TYPE == "SuperAdmin" && obj != null)
            {
